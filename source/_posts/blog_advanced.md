...
几个月前，写过几篇关于[Hexo博客搭建的教程](https://wjnovember.github.io/blog_basic/)，最近几天，发现有一些读者私信一些Hexo搭建过程中遇到的问题，于是笔者重新燃起Hexo博客的兴趣，花了一两天的时间重新将Hexo博客搭建了一下，并通过配置实现了一些附加功能，写下此篇教程，希望可以帮助读者们深入了解Hexo博客的使用。

本篇教程基于NexT主题的博客配置，实现更换主题、评论、打赏等功能，接下来根据这些功能进行分点描述。

# 搭建基本Hexo博客

Hexo博客基本搭建参考：《[全民博客时代的到来——20分钟简要教程](https://wjnovember.github.io/blog_basic/)》一文，笔者按照教程的顺序一步一步来，是没有出现错误的，如果读者们在搭建的时候遇到了问题不知如何解决，可以自行查阅网上资料，或私信笔者。

# Hexo博客绑定域名
关于Hexo博客如何绑定自己的域名，详情可参阅《[域名绑定，让你的博客拥有自己的个性](https://wjnovember.github.io/blog_domain/)》一文。
